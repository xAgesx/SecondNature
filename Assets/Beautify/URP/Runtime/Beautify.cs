...
namespace Beautify.Universal {
    ...
    public class Beautify : VolumeComponent, IPostProcessComponent {
        ...
        [ImageEnhancement, EdgeAntialiasing, DisplayName("Strength"), DisplayConditionBool("stripBeautifyEdgeAA", false), Tooltip("Strength of the integrated edge antialiasing. A value of 0 disables this feature."), ShowStrippedLabel]
        ...
        [LensAndLightingEffects, Bloom, DisplayName("Use Layers")]
        public BoolParameter bloomExcludeLayers = new BoolParameter(false);

        [LensAndLightingEffects, Bloom, DisplayName("Include/Exclude Layers"), DisplayConditionBool("bloomExcludeLayers"), Tooltip("Choose if bloom should be applied only to specified layers or if bloom should be excluded from the specified layers.")]
        ...
        [LensAndLightingEffects, Bloom, DisplayName("Layers"), DisplayConditionBool("bloomExcludeLayers")]
        ...
        [LensAndLightingEffects, AnamorphicFlares, DisplayName("Include/Exclude Layers"), DisplayConditionBool("anamorphicFlaresExcludeLayers"), Tooltip("Choose if the effect should be applied only on the specified layers or if it should be excluded instead.")]
        ...
        [LensAndLightingEffects, AnamorphicFlares, DisplayName("Layers"), DisplayConditionBool("anamorphicFlaresExcludeLayers")]
        ...
        [LensAndLightingEffects, SunFlares, DisplayName("Depth Occlusion Mode"), Tooltip("None = no depth buffer checking. Simple = sample depth buffer at Sun position. Smooth = sample 4 positions around Sun position and interpolate value across frames.")]
        ...
        [LensAndLightingEffects, DepthOfField, DisplayName("Enable"), ToggleAllFields, DisplayConditionBool("stripBeautifyDoF", false), ShowStrippedLabel]
        ...
        [ArtisticChoices, Outline, DisplayConditionBool("stripBeautifyOutline", false), ShowStrippedLabel]
        ...
        [ArtisticChoices, Outline, DisplayName("Min Depth Threshold")]
        public ClampedFloatParameter outlineMinDepthThreshold = new ClampedFloatParameter(0f, 0f, 1f);
        ...
        [ArtisticChoices, Outline, DisplayName("Use Optimized Shader"), DisplayConditionBool("outlineCustomize"), Tooltip("By default a depth-only custom shader is used to generate an outline mask. If the scene uses shaders that transform the vertices coordinates, you may want to disable this option.")]
        public BoolParameter outlineUsesOptimizedShader = new BoolParameter(false);

#if UNITY_2022_3_OR_NEWER
        [ArtisticChoices, Outline, DisplayName("Cut Off"), DisplayConditionBool("outlineCustomize"), Tooltip("Optionally set the alpha test/cut off. Only applies if optimized shader is used.")]
